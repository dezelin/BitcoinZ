    ...
    type T() = 
        ...
        static let localIp() =
            ...
            if addresses.Length = 0 then zeroIp
                ...
                try 
                    let localIp = Seq.find (fun (y: IPAddress) -> y.AddressFamily = AddressFamily.InterNetwork) addresses
        ...
        static member tearUp (context : TestContext) = 
            SocketServer.start server |> ignore
        ...
        member x.initialize() = 
            ...
            let connection = 
                SocketClient.asyncConnect client 
